...
/* GLITCH FLICKER OVERLAY - toggled by JS occasionally */
#game.flicker::after {
    content: '';
    position: fixed;
    top: 0;
...
.menu-box::before, .ending-box::before {
    content: '';
    position: absolute;
    top: -8px;
    left: -8px;
...
.ending-box.true-ending {
    border-color: #00ff00;
    box-shadow: 0 0 50px rgba(0, 255, 0, 0.6),
                inset 0 0 50px rgba(0, 255, 0, 0.1);
}

.ending-box.true-ending::before {
    border-color: #00ff00;
}

.ending-box.true-ending h2 {
    color: #00ff00 !important;
    text-shadow: 0 0 10px #00ff00, 0 0 20px #00ff00 !important;
}

.menu-box h1, .ending-box h2 {
    font-size: 3.5em;
    color: #ff0000;
...
/* TOUCH CONTROLS - hidden by default, shown on coarse pointer (touch) devices */
.touch-controls {
    display: none;
